...
app.use(function(req, res, next) {
    res.header("Access-Control-Allow-Origin", "http://www.egeotechnical.com/createbudget.php");
    res.header("Access-Control-Allow-Origin", "http://www.egeotechnical.com/engineering.php");
    res.header("Access-Control-Allow-Origin", "http://www.egeotechnical.com");
    res.header("Access-Control-Allow-Origin", "https://www.egeotechnical.com/createbudget.php");
